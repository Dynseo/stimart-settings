This repo is used for shared settings that need to me the same between ios and android

it can be used as a submodule for stimart-ios and stimart-android. 
https://www.atlassian.com//git/tutorials/git-submodule

The Jsons are manged by Google Sheets :
